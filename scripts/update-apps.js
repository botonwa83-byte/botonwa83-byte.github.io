...
const APPS = [
  ...
  { id: "polapex", name: "PolApex", subtitle: "初高中道法 / 思想政治", appId: "6783150236", tagline: "把政治从背了就忘，变成可检索、可迁移、可输出。", description: "围绕高权重记忆、主体职责、材料切片、答案工厂和选择题排雷。", chips: ["材料切片", "答案工厂", "主体定位"], icon: "assets/polapex.png", tile: "tile-pol" },
